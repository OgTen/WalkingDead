...
local ITEM_TYPES = {
    ["Weapons"] = {"AR15", "AK47", "Scar H", "MP5", "Remington 870", "SKS", "VSS", "AS VAL", "SR-25", "M110", "MK14", "M14", "M9", "UMP", "UMP45", "MP5K", "Glock17", "M1911", "Colt Python", "BerretaM9", "Kar98K", "M1917", "M82A1", "FN Fal", "HK UMP-45", "AKS-74U", "Desert Eagle", "FN Five-seveN", "Model77E", "M40", "VSS Vintorez", "Mk 2 Grenade", "M67 Grenade", "M18 Smoke Grenade", "SPAS-12", "M16", "Ruger 10/22", "RPK"},
